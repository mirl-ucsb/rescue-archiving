...
> **Developed in the open.** rescue-archiving is released, versioned, and citable, and it continues to be refined in public; file formats may still evolve ahead of a 1.0. The cautions that matter are standing ones, not signs of immaturity: never treat any single tool as your only safeguard when protecting a source or preserving evidence, verify the saved copy and its record independently before relying on them, and keep your own copies of anything important. The boundaries are stated plainly in [What the tool protects, and what it does not](#what-the-tool-protects-and-what-it-does-not). Reports of whatever breaks are welcome.
